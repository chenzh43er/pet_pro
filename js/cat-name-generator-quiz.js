...
function bindQuizNavigation(page, pageCount, category) {
...
async function init() {
  ...
  const response = await fetch(`${ROOT}data/quiz/cat-questions.json`);
  ...
  bindQuizNavigation(page, quiz.pageCount, quiz.category);
  renderAside();
